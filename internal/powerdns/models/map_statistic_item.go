...
func (m *MapStatisticItem) validateValue(formats strfmt.Registry) error {
...
func (m *MapStatisticItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MapStatisticItem) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
